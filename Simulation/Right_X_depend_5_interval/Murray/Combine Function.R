setwd("/scratch/g/skim/CT_HD_Bayesian_ones(1228)/Right_X_depend_5_interval/Murray")
...
summary_func <- function(rds_data,true_value){
  ...
  raw_result <- raw_dt[,c(1:28,30,33,31,32)]
  raw_ci25 <- raw_25[,c(1:28,30,33,31,32)]
  raw_ci75 <- raw_75[,c(1:28,30,33,31,32)]
...
### Fully exchangeable
fullyex <- readRDS("fully_ex1(1).rds")
...
fullyex <- readRDS("fully_ex2.4(1).rds")
...
non02 <- readRDS("nonfully1_02(1).rds")
...
non02 <- readRDS("nonfully2.4_02(1).rds")
...
non02n <- readRDS("nonfully1_02n(1).rds")
non02n2 <- readRDS("nonfully1_02n(2).rds")
non02n <- c(non02n,non02n2)[1:500]
...
non02n <- readRDS("nonfully2.4_02n(1).rds")
non02n2 <- readRDS("nonfully2.4_02n(2).rds")
non02n <- c(non02n,non02n2)
...
non04 <- readRDS("nonfully1_04(1).rds")
...
non04 <- readRDS("nonfully2.4_04(1).rds")
...
non08 <- readRDS("nonfully1_08(1).rds")
non082 <- readRDS("nonfully1_08(2).rds")
non08 <- c(non08,non082)[1:500]
...
non08 <- readRDS("nonfully2.4_08(1).rds")
...
non1.2 <- readRDS("nonfully1_1.2(1).rds")
...
non1.2 <- readRDS("nonfully2.4_1.2(1).rds")
non1.22 <- readRDS("nonfully2.4_1.2(2).rds")
non1.2 <- c(non1.2,non1.22)[1:500]
...
non1.6 <- readRDS("nonfully1_1.6(1).rds")
...
non1.6 <- readRDS("nonfully2.4_1.6(1).rds")
non1.62 <- readRDS("nonfully2.4_1.6(2).rds")
non1.6 <- c(non1.6,non1.62)[1:500]
...
non2.0 <- readRDS("nonfully1_2.0(1).rds")
...
non2.0 <- readRDS("nonfully2.4_2.0(1).rds")
