...
interval_gen <- function(true_time_dt, ### columns, "time","interval","Z,X1 - X9"
  ...
  censor_T_trans_final[which(censor_T_trans_final$censor==0 |
    ...
    (censor_T_trans_final$obs_L[which(censor_T_trans_final$censor==0 |
                                        censor_T_trans_final$censor==1)] + censor_T_trans_final$obs_R[which(censor_T_trans_final$censor==0 |
                                                                                                              censor_T_trans_final$censor==1)] )/2
  censor_T_trans_final[which(censor_T_trans_final$censor==0 |
